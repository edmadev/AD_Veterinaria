 ...
 * @author mauri_
 */
public class TablaTopMasPesados extends javax.swing.JPanel {

    /**
     * Creates new form LimiteRegistros
     */
    public TablaTopMasPesados() {
        initComponents();
        
    }
    
    /**
     * Establece la tabla con los más pesados.
     */
     private void iniciarTablaTopMasPesados() {
        ConsultasPaciente consulta = new ConsultasPaciente();
        DefaultTableModel modelo = new DefaultTableModel();

        ArrayList<Peso> topMasPesados = consulta.topMasPesados(returnLimite());
        modelo.addColumn("ID Mascota");
        modelo.addColumn("ID Peso");
        modelo.addColumn("Peso");

        for (Peso peso : topMasPesados) {
     ...
     /**
      * Establece el limite elegido por los usuarios
      * @return El límite.
      */
    ...
    private void initComponents() {
        ...
        btnMostrarResultados.setText("<html>Mostrar Resultados<br>Top Mas Pesados\n");
